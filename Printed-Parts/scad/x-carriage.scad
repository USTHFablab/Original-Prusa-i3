...
module final_cutout()
{
    ...
    // filament hole
    translate([-14.5,8.8,0]) rotate([-5,0,0]) cylinder(r=1.7, h=40, $fn=10);  
    translate([-14.5,9.7,10]) rotate([-5,0,0]) cylinder(r=1.7,r2=2, h=6, $fn=10);  
...
//       translate([-14.8,-22.6,-6]) rotate([45,45,0]) cube([10,15,10]);
